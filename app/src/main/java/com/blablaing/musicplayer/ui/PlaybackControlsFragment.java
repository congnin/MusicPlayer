...
import com.blablaing.musicplayer.AlbumArtCache;
...
public class PlaybackControlsFragment extends Fragment {
    ...
    private void onMetadataChanged(MediaMetadataCompat metadata) {
        ...
        if (!TextUtils.equals(artUrl, mArtUrl)) {
            ...
            AlbumArtCache cache = AlbumArtCache.getsInstance();
            if (art == null) {
            ...
            if (art != null) {
                ...
                cache.fetch(artUrl, new AlbumArtCache.FetchListener() {
                    ...
                    public void onFetched(String artUrl, Bitmap bitmap, Bitmap icon) {
                        if (icon != null) {
                            LogHelper.d(TAG, "albu art icon of w=", icon.getWidth(),
                                    " h=", icon.getHeight());
                            if (isAdded()) {
    ...
    private void onPlaybackStateChanged(PlaybackStateCompat state) {
        ...
        if (controller != null && controller.getExtras() != null) {
            String castName = controller.getExtras().getString(MusicService.EXTRA_CONNECTION_CAST);
            if (castName != null) {
